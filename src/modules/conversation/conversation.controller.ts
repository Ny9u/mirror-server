...
import { SaveConversationDto, GetConversationsDto, GetConversationDetailsQueryDto, DeleteConversationDto } from './conversation.dto';
...
export class ConversationController {
  ...
  async delete(@Body() dto: DeleteConversationDto) {
    return this.conversationService.deleteConversation(dto.userId, dto.conversationId);
  }
  ...
  async details(@Query() query: GetConversationDetailsQueryDto) {
    return this.conversationService.getConversationDetails(query.userId, query.conversationId);
  }
}
